...
import {UserService}        from '../services/ordered-product.service';
import {User}               from '../entities/ordered-product';
...
@Component({
  ...
  templateUrl: '../templates/ordered-product-form.component.html',
  providers: [
    UserService,
    RoleService]
})
