...
import {UserService}        from './product-material-quantity.service';
import {User}               from './product-material-quantity';
...
@Component({
  ...
  templateUrl: './product-material-quantity-form.component.html',
  providers: [
    UserService,
    RoleService]
})
